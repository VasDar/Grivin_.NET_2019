...
namespace BLL
{
	public class Storage: IAwardDAL, IUserDAL
	{
		...
		public Storage()
		{
			awardDAL = new AwardList();
			userDAL = new UserList();
		}

		public Storage(string connectionString)
		{
			userDAL = new UserData(connectionString);
			awardDAL = new AwardData(connectionString);
		}
